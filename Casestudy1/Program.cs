...
namespace Casestudy
{
    ...
    internal class App
    {
        ...
        {
            Student std = new Student(1011, "Mani", "06/6/1999");
            Student std1 = new Student(1023, "sai", "21/3/1999");
        ...
        public void Scenerio2()
        {
            ...
            students[0] = new Student(1234, "Ramu", "12/5/1998");
            students[1] = new Student(2345, "Raju", "28/08/1999");
        ...
        {
            Course course = new Course(102, "sree", 30, 12000.00f);
            info.display(course);
        }
