...
--2.Write a T-SQL Program to find the factorial of a given number.begin
declare @num int
...
print 'Factorial of the given number is : '+cast(@factorial as varchar)
end

--3.Create a stored procedure to generate multiplication tables up to a given number.
create or alter proc Multiplication_Table(@num1 int) as
begin
declare @num2 int = 1, @result int
while(@num2<=10)
begin
set @result = @num1 * @num2
print @result set @num2 = @num2+1
end
end
exec Multiplication_Table @num1=11
